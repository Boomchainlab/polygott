...
class AguToken::Test::PrimitiveModelTest < Minitest::Test
  A = AguToken::Internal::Type::ArrayOf[-> { Integer }]
  H = AguToken::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < AguToken::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      AguToken::Internal::Type::Unknown,
      AguToken::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => AguToken::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [AguToken::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [AguToken::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [AguToken::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = AguToken::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        AguToken::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [AguToken::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [AguToken::Internal::Type::Boolean, true] => true,
      [AguToken::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => AguToken::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        AguToken::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = AguToken::Internal::Type::Converter.new_coerce_state
      AguToken::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        AguToken::Internal::Type::Converter.dump(target, input, state: state)
...
class AguToken::Test::EnumModelTest < Minitest::Test
  class E0
    include AguToken::Internal::Type::Enum
    attr_reader :values
...
class AguToken::Test::CollectionModelTest < Minitest::Test
  A1 = AguToken::Internal::Type::ArrayOf[-> { Integer }]
  H1 = AguToken::Internal::Type::HashOf[Integer]

  A2 = AguToken::Internal::Type::ArrayOf[H1]
  H2 = AguToken::Internal::Type::HashOf[-> { A1 }]

  A3 = AguToken::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = AguToken::Internal::Type::HashOf[Integer, nil?: true]
...
class AguToken::Test::BaseModelTest < Minitest::Test
  class M1 < AguToken::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < AguToken::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < AguToken::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, AguToken::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = AguToken::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = AguToken::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(AguToken::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue AguToken::Errors::ConversionError => e
...
class AguToken::Test::UnionTest < Minitest::Test
  class U0
    include AguToken::Internal::Type::Union
  ...
  class M2 < AguToken::Internal::Type::BaseModel
  ...
  class M4 < AguToken::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, AguToken::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < AguToken::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, AguToken::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class AguToken::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include AguToken::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [AguToken::Internal::Type::Unknown, AguToken::Internal::Type::Unknown] => true,
      [AguToken::Internal::Type::Boolean, AguToken::Internal::Type::Boolean] => true,
      [AguToken::Internal::Type::Unknown, AguToken::Internal::Type::Boolean] => false,
