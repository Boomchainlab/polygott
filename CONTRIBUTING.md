...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/agu_token/helpers/` and `examples/` directory.
...
require_relative "../lib/agu_token"
...
```ruby
gem "agu-token", git: "https://www.github.com/stainless-sdks/agu-token-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/stainless-sdks/agu-token-ruby' '<path-to-repo>'
```

```ruby
gem "agu-token", path: "<path-to-repo>"
```
