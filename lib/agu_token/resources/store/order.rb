  ...
  module Resources
    class Store
      class Order
        ...
        #
        # @return [AguToken::Models::Order]
        #
        # @see AguToken::Models::Store::OrderCreateParams
        def create(params = {})
          parsed, options = AguToken::Store::OrderCreateParams.dump_request(params)
          @client.request(
            method: :post,
            path: "store/order",
            body: parsed,
            model: AguToken::Order,
            options: options
          )
        end
        ...
        # @return [AguToken::Models::Order]
        #
        # @see AguToken::Models::Store::OrderRetrieveParams
        ...
        # @return [nil]
        #
        # @see AguToken::Models::Store::OrderDeleteParams
