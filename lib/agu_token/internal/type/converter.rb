    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { AguToken::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { AguToken::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            AguToken::FilePart.new(value)
          in AguToken::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in AguToken::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [AguToken::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: AguToken::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in AguToken::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in AguToken::Internal::Type::Converter
              ...
              AguToken::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(AguToken::Internal::Type::Converter, T::Class[T.anything]) }
        end
